...
{
    public partial class pizza : sample
    {
        public pizza()
        {
            InitializeComponent();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            StreamWriter txt = File.AppendText("details.txt");
            txt.WriteLine("******************************");
            txt.Write(textBox11.Text);
            txt.WriteLine();
            txt.Write(textBox12.Text);
            txt.WriteLine();
            txt.Write(textBox13.Text);
            txt.WriteLine();
            txt.Write(textBox14.Text);
            txt.WriteLine();
            txt.Write(textBox15.Text);
            txt.WriteLine();
            txt.Write(textBox16.Text);
            txt.WriteLine();
            txt.Write(textBox17.Text);
            txt.WriteLine();
            txt.Close();
