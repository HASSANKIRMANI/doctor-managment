...
namespace OOP_PROJECT_WINDOW_FORM
{
    public abstract class doctor
    {
        ...
        //Used in child classes of doctor !
        ...
        public doctor(string FirstName, string LastName, string Username,string Password, int Age,
            string PhoneNo, string Gender, string Speciality, string Address, string PostalCode, string EmailAddress)
        {
            this._Age = Age;
        ...
        //fee
        public bool isFeeValid(double Fee)
        {
            if (Fee > 0) { return true; }
            else { return false; }

        }
        public abstract double _Fee { set; get; }

        //description
        public bool isDescriptionEmpty(string description)
        {
            return (string.IsNullOrEmpty(description));
        }
        public abstract string _description { set; get; }
    }
